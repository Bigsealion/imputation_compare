...
qsub_list=(all.q clc cluster2 cluster3 cluster5 cluster40 gpu long.q short.q verylong.q veryshort.q whole)
...
source_path=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s1.7_simulation_y/cog_newgroup/cvlt_Cov/s1.7_SimulationOutcomeData.RData

save_dir[1]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${datasetname}SimuY_TrueMiss_NoRep0.8
...
save_dir[2]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${datasetname}SimuY_20Miss_NoRep0.8
...
save_dir[3]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${datasetname}SimuY_40Miss_NoRep0.8
...
save_dir[4]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${datasetname}SimuY_60Miss_NoRep0.8
...
save_dir[5]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${datasetname}SimuY_80Miss_NoRep0.8
