...
source_path="/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s1.7_simulation_y/HarReho_gender/s1.7_SimulationOutcomeData.RData"
...
log_path[1]=$log_dir/s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_TrueMiss_NoRep0.8_boot100.txt
err_path[1]=$error_dir/ERROR_s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_TrueMiss_NoRep0.8_boot100.txt
...
log_path[2]=$log_dir/s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_20Miss_NoRep0.8_boot100.txt
err_path[2]=$error_dir/ERROR_s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_20Miss_NoRep0.8_boot100.txt
...
log_path[3]=$log_dir/s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_40Miss_NoRep0.8_boot100.txt
err_path[3]=$error_dir/ERROR_s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_40Miss_NoRep0.8_boot100.txt
...
log_path[4]=$log_dir/s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_60Miss_NoRep0.8_boot100.txt
err_path[4]=$error_dir/ERROR_s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_60Miss_NoRep0.8_boot100.txt
...
log_path[5]=$log_dir/s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_80Miss_NoRep0.8_boot100.txt
err_path[5]=$error_dir/ERROR_s2.1_SimuMiss_${datasetname}_${time_op}_${qsub_name}_80Miss_NoRep0.8_boot100.txt
