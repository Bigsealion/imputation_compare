...
source_p[1]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/Reho_age_Truemiss_NoRep0.8/s1.4_zRehoAAL116_Gender_CorCombine_Data.Rdata/simulation_boot_100_2021-03-08-18:30:43.RData
...
source_p[2]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/Reho_age_20miss_NoRep0.8/s1.4_zRehoAAL116_Gender_CorCombine_Data.Rdata/simulation_boot_100_2021-03-08-18:41:54.RData
...
source_p[3]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/Reho_age_40miss_NoRep0.8/s1.4_zRehoAAL116_Gender_CorCombine_Data.Rdata/simulation_boot_100_2021-03-08-18:37:18.RData
...
source_p[4]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/Reho_age_60miss_NoRep0.8/s1.4_zRehoAAL116_Gender_CorCombine_Data.Rdata/simulation_boot_100_2021-03-08-17:38:09.RData
...
source_p[5]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/Reho_age_80miss_NoRep0.8/s1.4_zRehoAAL116_Gender_CorCombine_Data.Rdata/simulation_boot_100_2021-03-08-17:41:35.RData
...
for i in ${run_index[*]};do
  ...
  qsub -q ${qsub_name} -e ${err_path[$i]} -N ${method}_${i}_${dataset_name} $script_dir/qmon_Rscript_run.sh ${source_p[$i]} ${save_dir[$i]} ${pt_s_dir[$i]} ${method} ${log_path[$i]}
  #sleep 1
done
