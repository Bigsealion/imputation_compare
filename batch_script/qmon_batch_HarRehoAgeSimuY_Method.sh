...
# datasetname="HarRehoAgeSimuY_"
# ls | grep ${datasetname} | xargs -i find ./{} -name  'simulation*'

source_p[1]="/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${dataset_name}_TrueMiss_NoRep0.8/${data_file_name}/simulation_boot_100_2022-11-26-18:07:37.RData"
...
source_p[2]="/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${dataset_name}_20Miss_NoRep0.8/${data_file_name}/simulation_boot_100_2022-11-26-18:08:11.RData"
...
source_p[3]="/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${dataset_name}_40Miss_NoRep0.8/${data_file_name}/simulation_boot_100_2022-11-26-18:09:32.RData"
...
source_p[4]="/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${dataset_name}_60Miss_NoRep0.8/${data_file_name}/simulation_boot_100_2022-11-26-18:10:45.RData"
...
source_p[5]="/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/${dataset_name}_80Miss_NoRep0.8/${data_file_name}/simulation_boot_100_2022-11-26-18:11:58.RData"
