...
qsub_log_dir=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/programm/qsub_log/
...
source_p[1]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/ReHo_TCoefSimuY_TrueMiss_NoRep0.8/s1.7_SimulationOutcomeData.RData/simulation_boot_100_2021-04-27-15:30:31.RData
...
source_p[2]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/ReHo_TCoefSimuY_20Miss_NoRep0.8/s1.7_SimulationOutcomeData.RData/simulation_boot_100_2021-04-27-15:33:39.RData
...
source_p[3]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/ReHo_TCoefSimuY_40Miss_NoRep0.8/s1.7_SimulationOutcomeData.RData/simulation_boot_100_2021-04-27-15:37:00.RData
...
source_p[4]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/ReHo_TCoefSimuY_60Miss_NoRep0.8/s1.7_SimulationOutcomeData.RData/simulation_boot_100_2021-04-27-15:38:53.RData
...
source_p[5]=/gpfs/lab/liangmeng/members/liyifan/R/imp_compare/s2_simulation/ReHo_TCoefSimuY_80Miss_NoRep0.8/s1.7_SimulationOutcomeData.RData/simulation_boot_100_2021-04-27-15:40:46.RData
...
for i in ${run_index[*]};do
  ...
  qsub -q ${qsub_name} -o ${qsub_log_dir} -e ${err_path[$i]} -N ${method}_${i}_${dataset_name} $script_dir/qmon_Rscript3.1.1Imp_run.sh ${source_p[$i]} ${save_dir[$i]} ${pt_s_dir[$i]} ${method} ${log_path[$i]}
  #sleep 0.2
done
